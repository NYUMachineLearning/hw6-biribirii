...
* When applied to the test set, the model performs with a moderate accuracy of 76.6% but worse than the SVM with linear kernel with all the predictor variables.
```{r}
